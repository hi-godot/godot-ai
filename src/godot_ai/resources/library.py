...
def register_library_resources(mcp: FastMCP) -> None:
    ...
    async def get_editor_state(ctx: Context) -> str:
        ...
        return await safe_json(editor_handlers.editor_state(runtime))
    ...
    async def get_materials(ctx: Context) -> str:
        ...
        runtime = DirectRuntime.from_context(ctx)
        return await safe_json(material_handlers.material_list(runtime))
    ...
    async def get_input_map(ctx: Context) -> str:
        ...
        runtime = DirectRuntime.from_context(ctx)
        return await safe_json(input_map_handlers.input_map_list(runtime))
    ...
    async def get_performance(ctx: Context) -> str:
        ...
        runtime = DirectRuntime.from_context(ctx)
        return await safe_json(editor_handlers.performance_monitors_get(runtime))
    ...
    async def get_test_results(ctx: Context) -> str:
        ...
        runtime = DirectRuntime.from_context(ctx)
        return await safe_json(testing_handlers.test_results_get(runtime))
