...
def register_node_tools(mcp: FastMCP, *, include_non_core: bool = True) -> None:
    ...
    register_manage_tool(
        ...
        ops={
            "get_children": lambda rt, p: node_handlers.node_get_children(rt, **p),
            "get_groups": lambda rt, p: node_handlers.node_get_groups(rt, **p),
            "delete": lambda rt, p: node_handlers.node_delete(rt, **p),
            "duplicate": lambda rt, p: node_handlers.node_duplicate(rt, **p),
            "rename": lambda rt, p: node_handlers.node_rename(rt, **p),
            "move": lambda rt, p: node_handlers.node_move(rt, **p),
            "reparent": lambda rt, p: node_handlers.node_reparent(rt, **p),
            "add_to_group": lambda rt, p: node_handlers.node_add_to_group(rt, **p),
            "remove_from_group": lambda rt, p: node_handlers.node_remove_from_group(rt, **p),
        },
    )
