...
def register_particle_tools(mcp: FastMCP) -> None:
    register_manage_tool(
        ...
        ops={
            "create": lambda rt, p: particle_handlers.particle_create(rt, **p),
            "set_main": lambda rt, p: particle_handlers.particle_set_main(rt, **p),
            "set_process": lambda rt, p: particle_handlers.particle_set_process(rt, **p),
            "set_draw_pass": lambda rt, p: particle_handlers.particle_set_draw_pass(rt, **p),
            "restart": lambda rt, p: particle_handlers.particle_restart(rt, **p),
            "get": lambda rt, p: particle_handlers.particle_get(rt, **p),
            "apply_preset": lambda rt, p: particle_handlers.particle_apply_preset(rt, **p),
        },
    )
