...
def register_camera_tools(mcp: FastMCP) -> None:
    register_manage_tool(
        ...
        ops={
            "create": lambda rt, p: camera_handlers.camera_create(rt, **p),
            "configure": lambda rt, p: camera_handlers.camera_configure(rt, **p),
            "set_limits_2d": lambda rt, p: camera_handlers.camera_set_limits_2d(rt, **p),
            "set_damping_2d": lambda rt, p: camera_handlers.camera_set_damping_2d(rt, **p),
            "follow_2d": lambda rt, p: camera_handlers.camera_follow_2d(rt, **p),
            "get": lambda rt, p: camera_handlers.camera_get(rt, **p),
            "list": lambda rt, p: camera_handlers.camera_list(rt, **p),
            "apply_preset": lambda rt, p: camera_handlers.camera_apply_preset(rt, **p),
        },
    )
