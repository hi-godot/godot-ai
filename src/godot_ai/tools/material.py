...
def register_material_tools(mcp: FastMCP) -> None:
    register_manage_tool(
        ...
        ops={
            "create": lambda rt, p: material_handlers.material_create(rt, **p),
            "set_param": lambda rt, p: material_handlers.material_set_param(rt, **p),
            "set_shader_param": lambda rt, p: material_handlers.material_set_shader_param(rt, **p),
            "get": lambda rt, p: material_handlers.material_get(rt, **p),
            "list": lambda rt, p: material_handlers.material_list(rt, **p),
            "assign": lambda rt, p: material_handlers.material_assign(rt, **p),
            "apply_to_node": lambda rt, p: material_handlers.material_apply_to_node(rt, **p),
            "apply_preset": lambda rt, p: material_handlers.material_apply_preset(rt, **p),
        },
    )
