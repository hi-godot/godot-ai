...
func _continue_enter_tree_after_update_barrier() -> void:
	...
	_dispatcher.register_lazy("animation_preset_orbit", "animation", &"preset_orbit")
	_dispatcher.register_lazy("animation_preset_sweep", "animation", &"preset_sweep")
	_dispatcher.register_lazy("animation_preset_drift", "animation", &"preset_drift")
