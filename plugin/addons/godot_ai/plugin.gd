...
func _enter_tree() -> void:
	...
	_dispatcher.register("game_get_property", editor_handler.game_get_property)
	_dispatcher.register("game_set_property", editor_handler.game_set_property)
	_dispatcher.register("game_call_method", editor_handler.game_call_method)
	_dispatcher.register("game_click", editor_handler.game_click)
	_dispatcher.register("game_key_press", editor_handler.game_key_press)
	_dispatcher.register("game_mouse_move", editor_handler.game_mouse_move)
	_dispatcher.register("game_key_hold", editor_handler.game_key_hold)
	_dispatcher.register("game_key_release", editor_handler.game_key_release)
	_dispatcher.register("game_scroll", editor_handler.game_scroll)
	_dispatcher.register("game_list_signals", editor_handler.game_list_signals)
	_dispatcher.register("game_connect_signal", editor_handler.game_connect_signal)
	_dispatcher.register("game_disconnect_signal", editor_handler.game_disconnect_signal)
	_dispatcher.register("game_emit_signal", editor_handler.game_emit_signal)
	_dispatcher.register("game_pause", editor_handler.game_pause)
	_dispatcher.register("game_get_scene_tree", editor_handler.game_get_scene_tree)
	_dispatcher.register("game_get_node_info", editor_handler.game_get_node_info)
	_dispatcher.register("game_spawn_node", editor_handler.game_spawn_node)
	_dispatcher.register("game_remove_node", editor_handler.game_remove_node)
	_dispatcher.register("game_instantiate_scene", editor_handler.game_instantiate_scene)
	_dispatcher.register("game_get_performance", editor_handler.game_get_performance)
	_dispatcher.register("game_get_ui_elements", editor_handler.game_get_ui_elements)
	_dispatcher.register("game_get_nodes_in_group", editor_handler.game_get_nodes_in_group)
	_dispatcher.register("game_find_nodes_by_class", editor_handler.game_find_nodes_by_class)
	_dispatcher.register("game_get_camera", editor_handler.game_get_camera)
	_dispatcher.register("game_set_camera", editor_handler.game_set_camera)
	_dispatcher.register("game_raycast", editor_handler.game_raycast)
	_dispatcher.register("game_play_animation", editor_handler.game_play_animation)
	_dispatcher.register("game_serialize_state", editor_handler.game_serialize_state)
	_dispatcher.register("game_get_audio", editor_handler.game_get_audio)
	_dispatcher.register("game_audio_play", editor_handler.game_audio_play)
	_dispatcher.register("game_audio_bus", editor_handler.game_audio_bus)
	_dispatcher.register("game_environment", editor_handler.game_environment)
	_dispatcher.register("game_physics_body", editor_handler.game_physics_body)
	_dispatcher.register("game_light_3d", editor_handler.game_light_3d)
	_dispatcher.register("game_mesh_instance", editor_handler.game_mesh_instance)
	_dispatcher.register("game_navigate_path", editor_handler.game_navigate_path)
	_dispatcher.register("game_navigation_3d", editor_handler.game_navigation_3d)
	_dispatcher.register("game_animation_tree", editor_handler.game_animation_tree)
	_dispatcher.register("game_create_animation", editor_handler.game_create_animation)
	_dispatcher.register("game_skeleton_ik", editor_handler.game_skeleton_ik)
	_dispatcher.register("game_time_scale", editor_handler.game_time_scale)
	_dispatcher.register("game_window", editor_handler.game_window)
	_dispatcher.register("game_gamepad", editor_handler.game_gamepad)
	_dispatcher.register("game_mouse_drag", editor_handler.game_mouse_drag)
	_dispatcher.register("game_ui_debug", editor_handler.game_ui_debug)
	_dispatcher.register("game_debug_draw", editor_handler.game_debug_draw)
	_dispatcher.register("game_input_state", editor_handler.game_input_state)
	_dispatcher.register("game_create_timer", editor_handler.game_create_timer)
	_dispatcher.register("game_tween_property", editor_handler.game_tween_property)
